...
# GitHub OAuth (all envs)
config :ueberauth, Ueberauth.Strategy.Github.OAuth,
  client_id: System.get_env("GITHUB_CLIENT_ID"),
  client_secret: System.get_env("GITHUB_CLIENT_SECRET")

# GitLab OAuth (all envs)
gitlab_url = System.get_env("GITLAB_URL") || "https://gitlab.com"
...
config :argus,
  token_secret: System.get_env("TOKEN_SECRET") || "dev_token_secret_change_in_prod",
  github_webhook_secret: System.get_env("GITHUB_WEBHOOK_SECRET") || "",
  gitlab_url: gitlab_url,
  github_orgs: System.get_env("GITHUB_ORGS", "") |> String.split(",", trim: true)
